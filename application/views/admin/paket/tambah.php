<form action="<?php echo base_url('admin/paket/tambah') ?>" method="post">
<h3>Tambah data paket</h3>
<div class="col-md-12">
	<div class="form-group">
		<label>Nama</label>
		<input type="text" name="nama_paket" class="form-control" value="<?php echo set_value('nama_paket') ?>">
	...
	<div class="form-group">
		...
		<input type="text" name="lama_proses" class="form-control" value="<?php echo set_value('lama_proses') ?>">
