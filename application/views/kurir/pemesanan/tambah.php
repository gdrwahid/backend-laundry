...
<div class="row">
<div class="col-md-12">
<form action="<?php echo base_url('kurir/pemesanan/tambah') ?>" method="post" id="pilihanKiloan">
...
<div class="col-md-12">
	...
	<div class="form-group">
		...
		<a href="<?php echo base_url('kurir/pemesanan') ?>" class="btn btn-warning">Kembali</a>
	</div>

</div>
</form>
<form action="<?php echo base_url('kurir/pemesanan/proses') ?>" method="post" id="pilihanSatuan">
